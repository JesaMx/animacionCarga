...
;(function () {
  ...
  // establese el origen de transformacion en bombillas 
  ...
  //crea lines de tiempo secundarias
  ...
  const processHue = e => {
    if (e.key !== undefined && parseInt(e.key, 10) !== undefined) {
      ...
      if (HUE.length === 3) {
        ...
        // Restablese el tono independiente de si es valido 
        HUE = '';
      }
    }
  };
